def longestSubsequence(arr, difference):
    ...
    # make a memorization dictionary
    memo = {}
    ...
    def helper(num, position):
        ...
        # If we have already computed the result for this
        if (num, position) in memo:
            return memo[(num, position)]
        ...
        # store the calculated value in the memo
        memo[(num, position)] = longest
